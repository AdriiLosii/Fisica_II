...
def create_polygon(center, normal_vector, radius, steps):
	...
	c = np.array(center)
	# Generamos un vector aleatorio no nulo y que no este alineado con n
	while True:
